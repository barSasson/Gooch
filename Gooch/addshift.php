              ...
              <label class="btn default-input-style"  style="padding: 10px;">
				...
				<div class="col-md-4" align="center">
					<div class="jumbotron">
						<div class="container">
							<p>Tips</p>
							<input type="number" class="form-control default-input-style" id="tips-input" placeholder="Total Tips" style='width:100%; text-align: center; color: #ffffff'>
						</div>
						<div class="container">
							<p>Date</p>
							<div id="datePickerContainer">
								<input id='datePicker' data-provide='datepicker' data-date-container='#datePickerContainer' class="datepicker form-control default-input-style input-md" type="text" style='width:100%; text-align: center; color: #ffffff'>
							</div>
						</div>
						<div class="container">
							<p>Extra Data</p>		
