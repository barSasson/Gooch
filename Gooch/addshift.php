					...
					<div class="jumbotron">
						...
						<div class="container">
							...
							<div id="datePickerContainer">
								<input id='datePicker' data-provide='datepicker' data-date-container='#datePickerContainer' class=" form-control default-input-style" type="text" style='text-align: center; color: #ffffff'>
							</div>
						</div>
						<div class="container">
							<p>Extra Data</p>		
