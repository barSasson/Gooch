					...
					<div class="jumbotron">
						...
						<div class="container">
							...
							<div id="datePickerContainer">
								<input id='datePicker' data-provide='datepicker' data-date-container='#datePickerContainer' class="datepicker form-control default-input-style input-md" type="text" style='width:50%; text-align: center; color: #ffffff'>
							</div>
						</div>
						<div class="container">
							<p>Extra Data</p>		
